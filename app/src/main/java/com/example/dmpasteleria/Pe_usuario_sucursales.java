...
public class Pe_usuario_sucursales extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pe_usuario_sucursales);
    ...
    public void showChangeLanguageDialog(MenuItem menu) {
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(Pe_usuario_sucursales.this);
